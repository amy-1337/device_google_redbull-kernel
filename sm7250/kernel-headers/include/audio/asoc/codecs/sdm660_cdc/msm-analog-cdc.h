...
static __inline__ int msm_anlg_cdc_mclk_enable(struct snd_soc_component *component,
					   int mclk_enable, bool dapm)
{
	return 0;
}
static __inline__ int msm_anlg_cdc_hs_detect(struct snd_soc_component *component,
				struct wcd_mbhc_config *mbhc_cfg)
{
	return 0;
}
static __inline__ void msm_anlg_cdc_hs_detect_exit(
			struct snd_soc_component *component)
{

}
static __inline__ void sdm660_cdc_update_int_spk_boost(bool enable)
{

}
static __inline__ void msm_anlg_cdc_spk_ext_pa_cb(
		int (*codec_spk_ext_pa)(struct snd_soc_component *component,
		int enable), struct snd_soc_component *codec)
{

}
static __inline__ int msm_anlg_codec_info_create_codec_entry(
