 ...
 * @return:             Success or Failure
 */
int cam_io_memcpy(void *dest_addr,
 ...
 * @return:             Success or Failure
 */
int cam_io_memcpy_mb(void *dest_addr,
	void *src_addr, uint32_t len);
 ...
 */
int cam_io_poll_value_wmask(void *addr, uint32_t wait_data,
 ...
 * handler, spin_lock etc.
 */
int cam_io_poll_value(void *addr, uint32_t wait_data, uint32_t retry,
 ...
 * @return:             Success or Failure
 */
int cam_io_w_same_offset_block(const uint32_t *data, void *addr,
	uint32_t len);
 ...
 * @return:             Success or Failure
 */
int cam_io_w_mb_same_offset_block(const uint32_t *data, void *addr,
	uint32_t len);
 ...
 * @return:             Success or Failure
 */
int cam_io_dump(void *base_addr, uint32_t start_offset, int size);
