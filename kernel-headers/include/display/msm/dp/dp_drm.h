...
#else
static __inline__ int dp_connector_config_hdr(struct drm_connector *connector,
...
static __inline__ int dp_connector_post_init(struct drm_connector *connector,
		void *display)
{
	return 0;
}

static __inline__ enum drm_connector_status dp_connector_detect(
...
static __inline__ int dp_connector_get_modes(struct drm_connector *connector,
		void *display, const struct msm_resource_caps_info *avail_res)
{
	return 0;
}

static __inline__ enum drm_mode_status dp_connector_mode_valid(
		struct drm_connector *connector,
		struct drm_display_mode *mode,
		void *display, const struct msm_resource_caps_info *avail_res)
{
...
static __inline__ int dp_connector_get_mode_info(struct drm_connector *connector,
		const struct drm_display_mode *drm_mode,
		struct msm_mode_info *mode_info,
		void *display, const struct msm_resource_caps_info *avail_res)
{
...
static __inline__ int dp_connector_get_info(struct drm_connector *connector,
		struct msm_display_info *info, void *display)
{
	return 0;
}

static __inline__ void dp_connector_post_open(struct drm_connector *connector,
		void *display)
{
}

static __inline__ int dp_drm_bridge_init(void *display, struct drm_encoder *encoder)
{
	return 0;
}

static __inline__ void dp_drm_bridge_deinit(void *display)
{
}

static __inline__ void convert_to_drm_mode(const struct dp_display_mode *dp_mode,
				struct drm_display_mode *drm_mode)
{
}

static __inline__ int dp_mst_drm_bridge_init(void *display,
	struct drm_encoder *encoder)
{
	return 0;
}

static __inline__ void dp_mst_drm_bridge_deinit(void *display)
{
}

static __inline__ int dp_mst_init(struct dp_display *dp_display)
{
	return 0;
}

static __inline__ int dp_mst_deinit(struct dp_display *dp_display)
{
	return 0;
}
#endif
