...
/**
 * True __inline__ rotation supported versions
 */
 ...
 * @SDE_SSPP_TRUE_INLINE_ROT, Support of SSPP true __inline__ rotation v1
 * @SDE_SSPP_PREDOWNSCALE    Support pre-downscale X-direction by 2 for __inline__
 * @SDE_SSPP_PREDOWNSCALE_Y  Support pre-downscale Y-direction for __inline__
 ...
 * @in_rot_format_list: Pointer to list of supported formats for __inline__ rotation
 * @in_rot_maxdwnscale_rt_num: max downscale ratio for __inline__ rotation
 *                                 rt clients - numerator
 * @in_rot_maxdwnscale_rt_denom: max downscale ratio for __inline__ rotation
 *                                 rt clients - denominator
 * @in_rot_maxdwnscale_nrt: max downscale ratio for __inline__ rotation nrt clients
 ...
 *                                    must be enabled on HW with this support.
 * @in_rot_maxheight: max pre rotated height for __inline__ rotation
 ...
 * @inline_linewidth max source pipe linewidth for __inline__ rotation
 ...
 * @true_inline_rot_rev	__inline__ rotator feature revision
 ...
 * @inline_rot_formats	formats supported by the __inline__ rotator feature
 ...
 */
static __inline__ bool sde_hw_sspp_multirect_enabled(const struct sde_sspp_cfg *cfg)
{
...
static __inline__ bool sde_hw_intf_te_supported(const struct sde_mdss_cfg *sde_cfg)
{
