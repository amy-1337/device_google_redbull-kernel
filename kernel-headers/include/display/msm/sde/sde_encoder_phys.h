...
static __inline__ int sde_encoder_phys_inc_pending(struct sde_encoder_phys *phys)
{
...
static __inline__ enum sde_3d_blend_mode sde_encoder_helper_get_3d_blend_mode(
 ...
 */
static __inline__ bool sde_encoder_phys_is_cwb_disabling(
 ...
 */
static __inline__ bool _sde_encoder_phys_is_dual_ctl(
		struct sde_encoder_phys *phys_enc)
{
	struct sde_kms *sde_kms;
	enum sde_rm_topology_name topology;
 ...
 */
static __inline__ bool _sde_encoder_phys_is_ppsplit(
		struct sde_encoder_phys *phys_enc)
{
	enum sde_rm_topology_name topology;
...
static __inline__ bool sde_encoder_phys_needs_single_flush(
		struct sde_encoder_phys *phys_enc)
{
	if (!phys_enc)
		return false;
