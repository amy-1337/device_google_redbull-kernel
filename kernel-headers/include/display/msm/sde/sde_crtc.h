 ...
 */
static __inline__ int sde_crtc_get_mixer_width(struct sde_crtc *sde_crtc,
 ...
 */
static __inline__ int sde_crtc_get_mixer_height(struct sde_crtc *sde_crtc,
		struct sde_crtc_state *cstate, struct drm_display_mode *mode)
{
	if (!sde_crtc || !cstate || !mode)
		return 0;
 ...
 */
static __inline__ int sde_crtc_frame_pending(struct drm_crtc *crtc)
{
 ...
 */
static __inline__ void sde_crtc_set_needs_hw_reset(struct drm_crtc *crtc)
{
	struct sde_crtc *sde_crtc;
 ...
 * @crtc: Pointer to drm crtc object
 */
static __inline__ int sde_crtc_request_frame_reset(struct drm_crtc *crtc)
{
 ...
 */
static __inline__ enum sde_crtc_client_type sde_crtc_get_client_type(
						struct drm_crtc *crtc)
{
 ...
 */
static __inline__ bool sde_crtc_is_rt_client(struct drm_crtc *crtc,
		struct drm_crtc_state *cstate)
{
	if (!crtc || !cstate)
		return true;
 ...
 * @crtc: Pointer to crtc
 */
static __inline__ bool sde_crtc_is_enabled(struct drm_crtc *crtc)
{
 ...
 */
static __inline__ bool sde_crtc_is_reset_required(struct drm_crtc *crtc)
{
	/*
 ...
 * return: secure_level
 */
static __inline__ int sde_crtc_get_secure_level(struct drm_crtc *crtc,
 ...
 */
static __inline__ bool sde_crtc_atomic_check_has_modeset(
 ...
 * @crtc: Pointer to drm crtc structure
 */
static __inline__ void sde_crtc_set_compression_ratio(
