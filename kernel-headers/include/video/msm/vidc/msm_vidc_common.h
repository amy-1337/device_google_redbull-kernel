...
static __inline__ bool is_turbo_session(struct msm_vidc_inst *inst)
{
	return !!(inst->flags & VIDC_TURBO);
}

static __inline__ bool is_thumbnail_session(struct msm_vidc_inst *inst)
{
	return !!(inst->flags & VIDC_THUMBNAIL);
}

static __inline__ bool is_low_power_session(struct msm_vidc_inst *inst)
{
	return !!(inst->flags & VIDC_LOW_POWER);
}

static __inline__ struct v4l2_ctrl *get_ctrl(struct msm_vidc_inst *inst,
	u32 id)
{
	int i;
...
static __inline__ void update_ctrl(struct v4l2_ctrl *ctrl, s32 val, u32 sid)
{
	switch (ctrl->type) {
...
static __inline__ u32 get_v4l2_codec(struct msm_vidc_inst *inst)
{
...
static __inline__ bool is_image_session(struct msm_vidc_inst *inst)
{
...
static __inline__ bool is_grid_session(struct msm_vidc_inst *inst)
{
...
static __inline__ bool is_video_session(struct msm_vidc_inst *inst)
{
	return !is_grid_session(inst);
}
static __inline__ bool is_realtime_session(struct msm_vidc_inst *inst)
{
...
static __inline__ bool is_low_latency_hint(struct msm_vidc_inst *inst)
{
	struct v4l2_ctrl *ctrl;
...
static __inline__ bool is_secure_session(struct msm_vidc_inst *inst)
{
	return !!(inst->flags & VIDC_SECURE);
}

static __inline__ bool is_decode_session(struct msm_vidc_inst *inst)
{
	return inst->session_type == MSM_VIDC_DECODER;
}

static __inline__ bool is_encode_session(struct msm_vidc_inst *inst)
{
	return inst->session_type == MSM_VIDC_ENCODER;
}

static __inline__ bool is_primary_output_mode(struct msm_vidc_inst *inst)
{
	return inst->stream_output_mode == HAL_VIDEO_DECODER_PRIMARY;
}

static __inline__ bool is_secondary_output_mode(struct msm_vidc_inst *inst)
{
	return inst->stream_output_mode == HAL_VIDEO_DECODER_SECONDARY;
}

static __inline__ bool in_port_reconfig(struct msm_vidc_inst *inst)
{
	return inst->in_reconfig && inst->bufq[INPUT_PORT].vb2_bufq.streaming;
}

static __inline__ bool is_input_buffer(struct msm_vidc_buffer *mbuf)
{
	return mbuf->vvb.vb2_buf.type == INPUT_MPLANE;
}

static __inline__ bool is_output_buffer(struct msm_vidc_buffer *mbuf)
{
	return mbuf->vvb.vb2_buf.type == OUTPUT_MPLANE;
}

static __inline__ bool is_internal_buffer(enum hal_buffer type)
{
	u32 buf_type =
...
static __inline__ int msm_comm_g_ctrl(struct msm_vidc_inst *inst,
		struct v4l2_control *ctrl)
{
	return v4l2_g_ctrl(&inst->ctrl_handler, ctrl);
}

static __inline__ int msm_comm_s_ctrl(struct msm_vidc_inst *inst,
		struct v4l2_control *ctrl)
{
	return v4l2_s_ctrl(NULL, &inst->ctrl_handler, ctrl);
}

static __inline__ bool is_valid_operating_rate(struct msm_vidc_inst *inst, s32 val)
{
