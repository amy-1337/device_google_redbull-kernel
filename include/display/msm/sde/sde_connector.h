 ...
 */
static __inline__ uint64_t sde_connector_get_topology_name(
		struct drm_connector *connector)
{
 ...
 */
static __inline__ enum sde_rm_topology_name sde_connector_get_old_topology_name(
		struct drm_connector_state *state)
{
 ...
 */
static __inline__ int sde_connector_set_old_topology_name(
		struct drm_connector_state *state,
 ...
 */
static __inline__ uint64_t sde_connector_get_lp(
		struct drm_connector *connector)
{
	if (!connector || !connector->state)
		return 0;
 ...
 */
static __inline__ bool sde_connector_needs_offset(struct drm_connector *connector)
{
