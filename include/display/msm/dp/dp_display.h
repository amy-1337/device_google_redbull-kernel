...
#else
static __inline__ int dp_display_get_num_of_displays(void)
{
	return 0;
}
static __inline__ int dp_display_get_displays(void **displays, int count)
{
	return 0;
}
static __inline__ int dp_display_get_num_of_streams(void)
{
	return 0;
}
static __inline__ int dp_connector_update_pps(struct drm_connector *connector,
