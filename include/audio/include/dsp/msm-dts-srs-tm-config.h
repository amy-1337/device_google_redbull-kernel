...
#else
static __inline__ void msm_dts_srs_tm_ion_memmap(struct param_outband *po_) { }
static __inline__ void msm_dts_srs_tm_init(int port_id, int copp_idx) { }
static __inline__ void msm_dts_srs_tm_deinit(int port_id) { }
static __inline__ void msm_dts_srs_tm_add_controls(
