...
static __inline__ int wcd_cpe_get_lsm_ops(struct wcd_cpe_lsm_ops *lsm_ops)
{
	return 0;
}
static __inline__ int wcd_cpe_get_afe_ops(struct wcd_cpe_afe_ops *afe_ops)
{
	return 0;
}
static __inline__ void *wcd_cpe_get_core_handle(struct snd_soc_component *component)
{
	return NULL;
}
