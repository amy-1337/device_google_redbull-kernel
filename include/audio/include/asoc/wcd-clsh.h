...
extern void wcd_clsh_set_hph_mode(struct snd_soc_component *component,
				  int mode);
#else
static __inline__ void wcd_cls_h_fsm(struct snd_soc_component *component,
		struct wcd_clsh_cdc_info *cdc_clsh_d,
		u8 clsh_event, u8 req_state,
		int int_mode)
{
...
static __inline__ extern void wcd_cls_h_init(struct wcd_clsh_cdc_info *clsh)
{
}

static __inline__ extern void wcd_clsh_set_hph_mode(struct snd_soc_component *component,
				  int mode)
{
}
