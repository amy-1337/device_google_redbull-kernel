...
static __inline__ void *tasha_get_afe_config(struct snd_soc_component *component,
				  enum afe_config_type config_type)
{
	return NULL;
}
static __inline__ int tasha_cdc_mclk_enable(struct snd_soc_component *component,
					int enable,
					bool dapm)
{
	return 0;
}
static __inline__ int tasha_cdc_mclk_tx_enable(struct snd_soc_component *component,
					   int enable,
					   bool dapm)
{
	return 0;
}
static __inline__ int tasha_enable_efuse_sensing(
				struct snd_soc_component *component)
{
	return 0;
}
static __inline__ int tasha_mbhc_hs_detect(struct snd_soc_component *component,
				struct wcd_mbhc_config *mbhc_cfg)
{
	return 0;
}
static __inline__ void tasha_mbhc_hs_detect_exit(
				struct snd_soc_component *component)
{

}
static __inline__ void tasha_mbhc_zdet_gpio_ctrl(
		int (*zdet_gpio_cb)(struct snd_soc_component *component,
				    bool high),
		struct snd_soc_component *component)
{
...
static __inline__ int tasha_codec_info_create_codec_entry(
		struct snd_info_entry *codec_root,
		struct snd_soc_component *component)
{
	return 0;
}
static __inline__ void tasha_event_register(
	int (*machine_event_cb)(struct snd_soc_component *component,
				enum wcd9335_codec_event),
	struct snd_soc_component *component)
{
...
static __inline__ int tasha_codec_enable_standalone_micbias(
				struct snd_soc_component *component,
				int micb_num,
				bool enable)
{
...
static __inline__ int tasha_set_spkr_mode(struct snd_soc_component *component,
				      int mode)
{
	return 0;
}
static __inline__ int tasha_set_spkr_gain_offset(
				struct snd_soc_component *component,
				int offset)
{
	return 0;
}
static __inline__ enum codec_variant tasha_codec_ver(void)
{
	return 0;
}
