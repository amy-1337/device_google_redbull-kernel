 ...
 * @return:             Success or Failure
 */
static __inline__ int cam_soc_util_w(struct cam_hw_soc_info *soc_info,
 ...
 * @return:             Success or Failure
 */
static __inline__ int cam_soc_util_w_mb(struct cam_hw_soc_info *soc_info,
	uint32_t base_index, uint32_t offset, uint32_t data)
{
	if (!CAM_SOC_GET_REG_MAP_START(soc_info, base_index))
		return -EINVAL;
 ...
 */
static __inline__ uint32_t cam_soc_util_r(struct cam_hw_soc_info *soc_info,
 ...
 * @return:             Value read from the register address
 */
static __inline__ uint32_t cam_soc_util_r_mb(struct cam_hw_soc_info *soc_info,
	uint32_t base_index, uint32_t offset)
{
	if (!CAM_SOC_GET_REG_MAP_START(soc_info, base_index))
		return 0;
